		<div class="form-group">
		  		<label class="col-sm-2 control-label">{{ trans('labels.role.name') }}：</label>
		  		<div class="col-sm-6">
		...
		<div class="form-group">
		  		<label class="col-sm-2 control-label">{{ trans('labels.role.display') }}：</label>
		  		<div class="col-sm-6">
		...
		<div class="hr-line-dashed"></div>
		<div class="form-group">
		  		<label class="col-sm-2 control-label">{{ trans('labels.role.status') }}：</label>
		  		<div class="col-sm-6">
