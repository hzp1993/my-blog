	  	...
	  	<div class="row">
	  		<div class="col-sm-12">
	  			<div class="ibox float-e-margins">
	  				<div class="ibox-title"><a class="fa fa-chevron-left" title="返回上一步"></a> 编辑权限</div>
	  				<div class="ibox-content">
		  				<form action="javascript:;" id="forms" class="form-horizontal" data-url="{{ url('admin/permission/edit') }}">
		  					{{ method_field('PUT') }}
		  					<input type="hidden" name="return_url" value="{{ url('admin/permission/list') }}">
